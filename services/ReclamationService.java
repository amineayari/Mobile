...
public class ReclamationService {
    ...
    public void addReclamation(Reclamation reclamation) {
        ...
        String url = Statics.BASE_URL + "/AddReclamJSON?sujet=" + reclamation.getSujet() + "&description=" 
                + reclamation.getSujet()+"&date="+reclamation.getDate() +"&user="+reclamation.getUser_id();
