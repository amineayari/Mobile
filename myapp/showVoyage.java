...
Button rent2 = new Button("Supprimer");
 cnt1.add(rent2);
            
        rent2.getAllStyles().setBgColor(0xF36B08);
            rent2.addActionListener((ActionEvent e) -> {
               Dialog alert = new Dialog("Attention");
                SpanLabel message = new SpanLabel("Etes-vous sur de vouloir supprimer ce Voyage?\nCette action est irréversible!");
                alert.add(message);
                ...
                ok.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent evt) {
                       VoyageService.getInstance().DeleteVoyage(v.getId());
